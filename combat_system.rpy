...
# Character states (0=ready, >0=cooldown turns)
...
screen character_slot(char_name, is_hero):
    ...
    frame:
        ...
        vbox:
            ...
            # Portrait area with click zones
            frame:
                xsize base_width
...
label start_battle:
    ...
    while enemy_hp > 0 and ally_hp > 0:
        "Choose your actions for Round [battle_round]!"

        # Player input handled by screen interactions
        pause
