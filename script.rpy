...
default hero_hp = 1.0   # 100% HP
default enemy_hp = 0.75 # 75% HP
...
screen round_ui():
    fixed:
        ...
        # Hero HP Bar
        add hp_bar_hero at hp_bar_pos

        # Enemy HP Bar
        add hp_bar_enemy at hp_bar_pos

        # Display Hero and Enemy HP values
        vbox:
            xalign 0.5
            yalign 0.5
            spacing 2
...
# ========================
# HP Bar and Wave Effect
# ========================
screen hp_bar(hero_or_enemy):
    if hero_or_enemy == "hero":
        # Hero HP bar
        add hp_bar_bg at hp_bar_pos
        add hp_fill at hero_hp_pos
        add wave at hero_wave_pos
    else:
        # Enemy HP bar
        add hp_bar_bg at enemy_hp_pos
        add hp_fill at enemy_hp_pos
        add wave at enemy_wave_pos
